    ...
    <div class="nav-list">
        ...
        <button id="mobileMenuButton">
            <div class="mobileMenu">
                <span id="menu" style="transform: translate(0,0%);">Menu</span>
...
//             <div class="nav-links">
//                 <ul>
//                     <li class="link li__logo" id="li-logo"><a href="#">
//                         <svg width="105" height="26" viewBox="0 0 105 26" fill="none"
//                         style="translate: none; rotate: none; scale: none; transform: translate(0px);">
//                         <path
//                             d="M44.3672 6.12227C44.3672 2.63764 42.7203 0.260498 39.249 0.260498H35.051V11.9032H39.136C42.6073 11.9032 44.3672 9.60729 44.3672 6.12227ZM36.5043 10.6168V1.53054H39.2006C41.9131 1.53054 42.8818 3.38698 42.8818 6.12227C42.8818 8.85834 41.8001 10.6168 39.0876 10.6168H36.5043Z"
...
//                     </svg>
//                         </a></li>
//                     <li class="nav__item link sidebar__links link__menu li__projects" id="projects"><a id="Projects" class="sidebar__links" href="#">PROJECTS</a></li>
//                     <li class="nav__item link sidebar__links link__menu li__products" id="products"><a id="Products" class="sidebar__links" href="#">PRODUCTS</a></li>
//                     <li class="nav__item link sidebar__links link__menu li__resources" id="resources"><a id="Resources" class="sidebar__links" href="#">RESOURCES</a></li>
//                     <li class="nav__item link link__menu li__about" id="about"><a id="About" href="#">ABOUT</a></li>
//                     <li class="link link__menu li__contact" id="contact"><a href="#">CONTACT</a></li>
//                     <li class="link link__menu li__samples" id="samples"><a href="#">SAMPLES<span>0</span></a></li>
//                     <li class="link menu__button" id="menu"><a href="#">MENU</a></li>
//                 </ul>
//             </div>
//         </nav>
//         <div class="nav__menu">
...
//                 <li class="list__item menu__item menu__li__projects"><a href="#">PROJECTS</a><span>87</span></li>
//                 <li class="list__item menu__item menu__li__products"><a href="#">PRODUCTS</a><span>33</span></li>
//                 <li class="list__item menu__item menu__li__resources"><a href="#">RESOURCES</a><span>25</span></li>
//                 <li class="list__item menu__item menu__li__about"><a href="#">ABOUT</a><span>00</span></li>
//                 <li class="list__item menu__item menu__li__contact"><a href="#">CONTACT</a><span>00</span></li>
//                 <li class="list__item menu__item menu__li__samples"><a href="#">SAMPLES</a><span>02</span></li>
//             </ul>
//         </div>`;
